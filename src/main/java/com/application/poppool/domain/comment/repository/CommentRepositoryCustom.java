...
public interface CommentRepositoryCustom {
    ...
    List<GetMyCommentResponse.MyCommentInfo> findByMyCommentsWithPopUpStore(String userId, CommentType commentType, List<SortCode> sortCodes, Pageable pageable);
